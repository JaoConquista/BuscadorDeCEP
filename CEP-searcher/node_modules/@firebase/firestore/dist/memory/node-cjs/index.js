...
<<<<<<< HEAD
var database6a3d9c64 = require('./database-6a3d9c64-0c9a8379.js');
...
<<<<<<< HEAD
    return new database6a3d9c64.DeleteFieldValueImpl('deleteField');
=======
...
<<<<<<< HEAD
    return new database6a3d9c64.ServerTimestampFieldValueImpl('serverTimestamp');
=======
...
<<<<<<< HEAD
    return new database6a3d9c64.ArrayUnionFieldValueImpl('arrayUnion', elements);
=======
...
function arrayRemove(...elements) {
    ...
    // update() since we'd need the Firestore instance to do this.
<<<<<<< HEAD
    return new database6a3d9c64.ArrayRemoveFieldValueImpl('arrayRemove', elements);
=======
...
<<<<<<< HEAD
    return new database6a3d9c64.NumericIncrementFieldValueImpl('increment', n);
=======
...
<<<<<<< HEAD
        this._delegate = new database6a3d9c64.FieldPath(...fieldNames);
=======
...
>>>>>>> d98fa87d3bd26ef0e88bc6afe46530c3f86f63c1
    ...
    static documentId() {
         ...
         */
<<<<<<< HEAD
        return new FieldPath(database6a3d9c64.FieldPath$1.keyField().canonicalString());
    }
    isEqual(other) {
        other = util.getModularInstance(other);
        if (!(other instanceof database6a3d9c64.FieldPath)) {
=======
...
<<<<<<< HEAD
    Firestore: database6a3d9c64.Firestore,
    GeoPoint: database6a3d9c64.GeoPoint,
    Timestamp: database6a3d9c64.Timestamp,
    Blob: database6a3d9c64.Blob,
    Transaction: database6a3d9c64.Transaction,
    WriteBatch: database6a3d9c64.WriteBatch,
    DocumentReference: database6a3d9c64.DocumentReference,
    DocumentSnapshot: database6a3d9c64.DocumentSnapshot,
    Query: database6a3d9c64.Query,
    QueryDocumentSnapshot: database6a3d9c64.QueryDocumentSnapshot,
    QuerySnapshot: database6a3d9c64.QuerySnapshot,
    CollectionReference: database6a3d9c64.CollectionReference,
    FieldPath,
    FieldValue,
    setLogLevel: database6a3d9c64.setLogLevel,
    CACHE_SIZE_UNLIMITED: database6a3d9c64.CACHE_SIZE_UNLIMITED
=======
...
<<<<<<< HEAD
    configureForFirebase(instance, (app, auth) => new database6a3d9c64.Firestore(app, new database6a3d9c64.Firestore$1(app, auth), new database6a3d9c64.MemoryPersistenceProvider()));
=======
